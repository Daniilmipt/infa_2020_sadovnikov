...
def sort(stroka):
    '''Функция ожидает массив из строк, берёт каждую строку, находит её численную часть и сортирует "пузырьком" по убыванию'''
...
'''Сортирую таблицу результатов по убыванию'''
sort(stroka) 
